 ...
 */
final class Version20210810083434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, place VARCHAR(255) NOT NULL, reference INT NOT NULL, buying_date DATE NOT NULL, end_sav DATE NOT NULL, price NUMERIC(10, 0) NOT NULL, utilisation_tips LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
